...
def customfunc(usern):
    ...
    # sites = SitesInformation("/Users/jaskaran/Documents/Projects/Deploy-API/sherlock/sherlock/resources/data.json")
    sites = SitesInformation("/opt/render/project/src/sherlock/sherlock/resources/data.json")
